...
export default function SignInForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!username) {
      setFormError(t('Auth.SignIn.EmailRequired'));
      return;
    }
    if (!password) {
      setFormError(t('Auth.SignIn.PasswordRequired'));
      return;
    }
    setFormError("");
          ...
          <div>
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                ...
                <Input
                  labelName={t('Auth.SignIn.Password')}
