...
//        public TokenGenerator(IWebHostEnvironment environment, ILogger logger, IAntiforgery xsrf, IOptionsSnapshot<YangOneAppConfig> optionsSnapshot, IConfiguration configuration)
//        {
...
//                var request = new HttpRequestMessage(HttpMethod.Post, _configuration["YangOneAppConfig:ApiTokenEndPoint"]);
