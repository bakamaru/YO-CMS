...
//        public Task SendTemplatedEmailAsync<T>(string subject, string templateKey, T context, int projectId = 0, params EmailAddress[] to)
//        {
//            var from = new EmailAddress() { Email = "noreply@onlinekachhya.com", DisplayName = "Full Moon Developer" };
...
//        public Task<long> SendTemplatedEmailreturnAsync<T>(string subject, string templateKey, T context, int projectId = 0, params EmailAddress[] to)
//        {
